...
RESULTS = {
    ...
    "2026-06-14|Côte d'Ivoire|Ecuador": (1, 0, "H"),
    "2026-06-14|Netherlands|Japan": (2, 2, "U"),
    "2026-06-14|Sweden|Tunisia": (5, 1, "H"),
    "2026-06-15|Spain|Cabo Verde": (0, 0, "U"),
    "2026-06-15|Belgium|Egypt": (1, 1, "U"),
    "2026-06-15|Saudi Arabia|Uruguay": (1, 1, "U"),
    "2026-06-15|IR Iran|New Zealand": (2, 2, "U"),
}
...
STATS_LINES = [
    ...
    "player_goals,Yasin Ayari,2",
    "player_goals,Elijah Just,2",
    ...
    "player_goals,Boualem Khoukhi,1",
    ...
    "player_goals,Virgil van Dijk,1",
    "player_goals,Crysencio Summerville,1",
    "player_goals,Keito Nakamura,1",
    "player_goals,Daichi Kamada,1",
    "player_goals,Amad Diallo,1",
    "player_goals,Alexander Isak,1",
    "player_goals,Viktor Gyokeres,1",
    "player_goals,Mattias Svanberg,1",
    "player_goals,Omar Rekik,1",
    "player_goals,Emam Ashour,1",
    "player_goals,Abdulelah Alamri,1",
    "player_goals,Maxi Araujo,1",
    "player_goals,Mohammad Mohebi,1",
    "player_goals,Ramin Rezaeian,1",
    "team_goals_scored,Germany,7",
    "team_goals_scored,Sweden,5",
    "team_goals_scored,USA,4",
    "team_goals_scored,Mexico,2",
    "team_goals_scored,Korea Republic,2",
    "team_goals_scored,Australia,2",
    "team_goals_scored,Netherlands,2",
    "team_goals_scored,Japan,2",
    "team_goals_scored,IR Iran,2",
    "team_goals_scored,New Zealand,2",
    ...
    "team_goals_scored,Côte d'Ivoire,1",
    "team_goals_scored,Tunisia,1",
    "team_goals_scored,Belgium,1",
    "team_goals_scored,Egypt,1",
    "team_goals_scored,Saudi Arabia,1",
    "team_goals_scored,Uruguay,1",
    "team_goals_conceded,Curaçao,7",
    "team_goals_conceded,Paraguay,4",
    "team_goals_conceded,Tunisia,5",
    "team_goals_conceded,South Africa,2",
    "team_goals_conceded,Czechia,2",
    "team_goals_conceded,Türkiye,2",
    "team_goals_conceded,Netherlands,2",
    "team_goals_conceded,Japan,2",
    "team_goals_conceded,New Zealand,2",
    "team_goals_conceded,IR Iran,2",
    ...
    "team_goals_conceded,Ecuador,1",
    "team_goals_conceded,Belgium,1",
    "team_goals_conceded,Egypt,1",
    "team_goals_conceded,Saudi Arabia,1",
    "team_goals_conceded,Uruguay,1",
